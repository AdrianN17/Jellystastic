...
function destructive_terrain_physic:hacer_hueco(index,poligono_destruir,cx,cy)
...
function destructive_terrain_physic:poly2mesh(points,uv_scale)
...
function destructive_terrain_physic:crear_poligonos_fisica(poligono)
...
function destructive_terrain_physic:get_area_poligono(poligono)
  local area = 0
...
function destructive_terrain_physic:poligono_floor(poligono_decimal)
...
function destructive_terrain_physic:validar_poligono_box2d(poligono)
...
function destructive_terrain_physic:iterador_validador(poligono)
  local lista={}
...
function destructive_terrain_physic:descartar_puntos_muertos(poligono,lista)
...
function destructive_terrain_physic:validar_primeros(poligono)
...
function destructive_terrain_physic:distance_squared(a,b)
  local c = a-b
  return self:dot(c,c)
end

function destructive_terrain_physic:dot(a,b)
  return a.x * b.x + a.y * b.y
end

function destructive_terrain_physic:buscar(index)
