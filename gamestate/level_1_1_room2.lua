...
local level_1_1_room2 = Class{
	__includes = Base
}
local i
local time=0
function level_1_1_room2:init()
...
function level_1_1_room2:enter(from)
	print("room " .. i)
	i=i+1
	self.from = from
...
function level_1_1_room2:update(dt)
	self.entidades:update(dt)
	counter=collectgarbage('count')/1000
	time=time+dt
end

function level_1_1_room2:keypressed(key)
...
function level_1_1_room2:keyreleased(key)
	self.entidades:keyreleased(key)
end

function level_1_1_room2:mousepressed(x,y,button)
	self.entidades:mousepressed(x,y,button)
end

function level_1_1_room2:mousereleased(x,y,button)
	self.entidades:mousereleased(x,y,button)
end

function level_1_1_room2:create()
	Base.init(self,"assets/maps/lv1-1_room2.lua",1.2,false)
	self.entidades:data()

	self.entidades:layer()

	self.name="level_1_1_room2"
end



return level_1_1_room2